...
const StartupShowcase = () => {
  ...
  const handleConnectClick = (e, founderId) => {
    e.stopPropagation();
    console.log('🤝 Connect clicked for:', founderId);
    ...
    <section className="startup-showcase-section">
      ...
      <div className="startup-showcase-container">
        ...
        <div className="database-status">
          ...
          <span>Connected to MongoDB • {startups.length} founders loaded</span>
        </div>
                ...
                <div className="card-content">
                  ...
                  <div className="card-actions">
                    ...
                    >
                      ...
                      <span className="btn-text">View Founder</span>
                    </button>
                    <button 
                      className="connect-btn"
                      onClick={(e) => handleConnectClick(e, startup.founderId)}
                    >
